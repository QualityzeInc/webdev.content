...
function custom_scripts() {
        ...
        wp_enqueue_script('wp-custom-video-js', get_template_directory_uri() . '/customization/js/jquery-modal-video.min.js');
}
...
function load_custom_script_style()
{
     ...
     wp_enqueue_style( 'wp-custom-css', get_template_directory_uri() . '/customization/css/custom.css' );
          wp_enqueue_style( 'wp-custom-video-css', get_template_directory_uri() . '/customization/css/modal-video.min.css' );

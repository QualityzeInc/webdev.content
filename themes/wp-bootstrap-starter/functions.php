...
// bellow for s symbol url search to search
...
//bellow code is for adding search box in home page primary menu

add_filter('wp_nav_menu_items','add_search_box_to_menu', 1, 2);
function add_search_box_to_menu( $items, $args ) {
    if( $args->theme_location == 'primary' )
        return $items."<li class='menu-header-search ml-2'>".get_search_form(false)."</li>";
    return $items;
}
//above function is for adding search field in primary menu

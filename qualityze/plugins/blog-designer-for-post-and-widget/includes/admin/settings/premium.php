	...
	<table class="wpos-plugin-pricing-table">
		...
		<colgroup></colgroup>	
	    	...
	    	<tr>
	    		...
	    		<th>
	    			<h2>Premium</h2>
	    			<p>Gain access to <strong>Blog Designer - Post and Widget</strong> included in <br /><strong>Essential Plugin Bundle</p>
	    ...
	    <tfoot>
	    	<tr>
	    		<th></th>
	    		<td></td>
	    		<td><p>Gain access to <strong>Blog Designer - Post and Widget</strong> included in <br /><strong>Essential Plugin Bundle</p>
		...
		<tbody>
			...
			<td>9 - (Post Grid, Post List, Post Slider, Post Carousel, Recent Post, Post Ticker, Post GridBox, Post GridBox Slider, Post Masonry)</td>
			</tr>
			<tr>
			...
			<tr>
			<th>Ticker View <span class="subtext">Display post in a Ticker view</span></th>
			<td><i class="dashicons dashicons-no-alt"> </i></td>
			<td><i class="dashicons dashicons-yes"> </i></td>
			</tr>
			<tr>
			<th>Masonry View <span class="subtext">Display post in a masonry view</span></th>
			<td><i class="dashicons dashicons-no-alt"> </i></td>
			<td><i class="dashicons dashicons-yes"> </i></td>
			</tr>
			<tr>

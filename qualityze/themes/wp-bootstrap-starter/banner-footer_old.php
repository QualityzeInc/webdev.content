  ...
  <div class="container-custom">
    <div class="row">
        ...
        <div class="col-md-8">
          <div class="newsticker">
                <div class="d-flex flex-row">
                  ...
                  <div class="py-2 pl-3">
                      <h3>Top Rated Document Management Software 2019</h3>
                      <p>Qualityze proven it once again. We are listed among “Top Rated Document Management Software 2019” by SOFTWAREWORLD for making electronic document management easy & secure. For more detail</p>
                  </div>
                </div>
          </div>
        </div>
        ...
        <div class="col-md-4 pb-2 pt-3 col-md-4 pb-2 pt-3 text-lg-right text-md-right">
                    <a href="#"><img class="q10height" src="http://webdev.qualityze.com/wp-content/themes/wp-bootstrap-starter/customization/images/Q10.png" alt=""></a>
        </div>
